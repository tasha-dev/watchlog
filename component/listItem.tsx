    ...
    >
      <div className="flex items-center justify-start gap-3 flex-1 overflow-hidden">
        <div className="flex items-center justify-start gap-3 shrink-0">
          ...
          <span className="text-current block text-left truncate lg:text-lg text-sm font-semibold">
            {data.index}
          </span>
        </div>
        <span className="text-left truncate block lg:text-base text-sm text-current font-semibold">
          {data.title}
        </span>
      </div>
